    ...
    public void Update()
    {
        ...
        float
            xMov = Input.GetAxisRaw(
                "Horizontal"); //Raw car on ne veux pas filtre. Récupère les mouvements du joueur horizontale (compris entre -1;1)
        float
            zMov = Input
                .GetAxisRaw("Vertical"); //Récupère les mouvements du joueur en verticale (compris entre -1;1)
